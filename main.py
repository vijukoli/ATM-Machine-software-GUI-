...
class ATMLogin(tk.Frame):
    ...
    def __init__(self, master=None, **kwargs):
        ...
        # HEADINGS
        self.head = tk.Label(self, text=' WELCOME TO VIJAY ATM ', justify='center', bg=w, font='Times 13')
        self.head.grid(row=0, column=0, pady=9,)

        self.log_head = tk.Label(self, text=f"{20 * '-'} LOGIN {20 * '-'}", justify='center', bg=w, font='Times 10')
        self.log_head.grid(row=1, column=0, pady=6)

        self.sig_head = tk.Label(self, text=f"{20 * '-'} SIGN UP {20 * '-'}", justify='center', bg=w, font='Times 10')
        self.sig_head.grid(row=6, column=0, pady=6)

        # LOGIN SECTION
        self.log_name = tk.Label(self, text='Account Holder Name', bg=w, font='Courier 10')
        self.log_name.grid(row=2, column=0, sticky='w')
        self.log_box1 = tk.Entry(self, bg=lg, textvariable=self.log, width=22)
        self.log_box1.grid(row=2, column=1, sticky='e', padx=2)

        self.log_pin = tk.Label(self, text='Account Pin', bg=w, font='Courier 10')
        self.log_pin.grid(row=3, column=0, sticky='w')
        self.log_box2 = tk.Entry(self, bg=lg, textvariable=self.pin, show='*', width=22)
        self.log_box2.grid(row=3, column=1, sticky='e', padx=2)

        self.log_btn = tk.Button(self, text='Login', bg=g, relief='flat', width=18, command=self.login)
        self.log_btn.grid(row=4, column=1, columnspan=2, pady=6, padx=2, sticky='e')

        self.log_out = tk.Label(self, text='', bg=w, font='Courier 9', width=19)
        self.log_out.grid(row=5, column=1, sticky='e')

        # SIGNUP SECTION
        self.reg_name = tk.Label(self, text='New Account Name', bg=w, font='Courier 9')
        self.reg_name.grid(row=7, column=0, sticky='w')
        self.log_box3 = tk.Entry(self, bg=lg, textvariable=self.reg_log, width=22)
        self.log_box3.grid(row=7, column=1, sticky='e', padx=2)

        self.sin_pin = tk.Label(self, text='Enter New Pin', bg=w, font='Courier 9')
        self.sin_pin.grid(row=8, column=0, sticky='w')
        self.log_box4 = tk.Entry(self, bg=lg, textvariable=self.reg_pin, show='*', width=22)
        self.log_box4.grid(row=8, column=1, sticky='e', padx=2)

        self.sin_pin1 = tk.Label(self, text='Enter Confirm Pin', bg=w, font='Courier 9')
        self.sin_pin1.grid(row=9, column=0, sticky='w')
        self.confirm_box = tk.Entry(self, bg=lg, textvariable=self.reg_pin1, show='*', width=22)
        self.confirm_box.grid(row=9, column=1, sticky='e', padx=2)

        self.sin_bal = tk.Label(self, text='Enter Initilize Balance', bg=w, font='Courier 9')
        self.sin_bal.grid(row=10, column=0, sticky='w')
        self.log_box5 = tk.Entry(self, bg=lg, textvariable=self.reg_bal, width=22)
        self.log_box5.grid(row=10, column=1, sticky='e', padx=2)
...
class ATMAction(tk.Frame):
    ...
    def __init__(self, name_var, master=None, **kwargs):
        ...
        self.withdraw = tk.Button(self, text='Withdraw', bg=lg, font='Courier 12', relief=tk.RAISED, width=10, height=4,
        ...
        self.deposit = tk.Button(self, text='Deposit', bg=lg, font='Courier 12', relief=tk.RAISED, width=10, height=4,
        ...
        self.logout = tk.Button(self, text=f'Logout', bg=lg, font='Courier 12', relief=tk.RAISED, command=self.logout)
